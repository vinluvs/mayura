        ...
        <div className="w-full max-w-md relative z-10">
          <div className="glass-sm rounded-3xl p-8 shadow-premium border border-white/10 dark:border-white/5 backdrop-blur-xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-light tracking-widest text-foreground uppercase mb-2">Create Account</h2>
              <p className="text-muted-foreground text-sm">Join Mayura to save your favorite looks.</p>
            </div>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="repeat-password" className="text-xs font-semibold tracking-wider uppercase text-muted-foreground">Repeat Password</Label>
                  <Input
                    id="repeat-password"
                    type="password"
                    required
